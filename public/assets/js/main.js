;(function($) {
    ...
    var mwTheme = {
            ...
            if ( $().waypoint ) {
                $('.progress-bar').on('on-appear', function() {
                    $(this).each(function() {
                        ...
                        $(this).parent('.mw-progress').find('.perc').addClass('show').animate({
                            "width": percent + '%'
                        },1000, "easeInCirc");
                    });
                });
        ...
        toggles: function() {
            ...
            $('.mw-toggle.active').find('.toggle-content').show();
        ...
        popupImage: function() {
            if ( $().magnificPopup ) {
                $('.mw-galleries, .mw-galleries-grid').each(function () {
        ...
        counter: function() {
            if ( $().countTo ) {
                $('.mw-counter').on('on-appear', function() {
        ...
        galleriesFlex: function() {
            $('.mw-galleries').each(function(){
                var itemW = $(this).data("width");
                var itemM = $(this).data("margin");

                $(this).children('#mw-carousel').flexslider({
                    animation: "slide",
                    controlNav: false,
                    animationLoop: false,
                    slideshow: false,
                    itemWidth: itemW,
                    itemMargin: itemM,
                    asNavFor: $(this).children('#mw-slider'),
                    prevText: '<i class="fa fa-angle-left"></i>',
                    nextText: '<i class="fa fa-angle-right"></i>'
                });
                $(this).children('#mw-slider').flexslider({
                    animation: "slide",
                    controlNav: false,
                    animationLoop: false,
                    slideshow: false,
                    sync: $(this).children('#mw-carousel'),
                    prevText: '<i class="fa fa-angle-left"></i>',
                    nextText: '<i class="fa fa-angle-right"></i>'
                });
            });
        ...
        galleriesCube: function() {
            $('.mw-galleries-grid').each(function() {
                var
                $this = $(this),
